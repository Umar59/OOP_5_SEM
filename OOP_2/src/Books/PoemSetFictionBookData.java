...
public class PoemSetFictionBookData extends FictionBookBase
{
    ...
    protected PoemSetFictionBookData()
    {
        Genre = "Genre";
        this.pagesCount = 0;
    ...
    protected PoemSetFictionBookData(String genre, int pagesCount, String authorName, 
    ...
    protected PoemSetFictionBookData(String genre, BookComplexity complexity, int pagesCount,
    ...
    public boolean equals(Object o) {
        ...
        PoemSetFictionBookData that = (PoemSetFictionBookData) o;
