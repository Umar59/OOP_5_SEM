...
public class NovelFictionBookData extends FictionBookBase
{
    ...
    protected NovelFictionBookData()
    {
        Genre = "Genre";
        this.pagesCount = 0;
    ...
    protected NovelFictionBookData(String genre, int pagesCount, String authorName,
    ...
    protected NovelFictionBookData(String genre, BookComplexity complexity, int pagesCount,
    ...
    public boolean equals(Object o) {
        ...
        NovelFictionBookData that = (NovelFictionBookData) o;
